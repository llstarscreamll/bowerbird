...
@Component({
  ...
  template: `
        ...
        <div class="flex items-start">
          ...
          <div class="ml-3 w-0 flex-1 pt-0.5">
            ...
            <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
              Install the app for faster launch and offline access.
            </p>
    ...
    @if (pwa.updateAvailable()) {
      <div
        class="fixed bottom-4 left-4 z-50 max-w-sm card border-indigo-200 dark:border-indigo-500/30 bg-indigo-50/50 dark:bg-indigo-900/10"
      >
        <div class="flex items-start">
          <div class="flex-shrink-0">
          ...
          <div class="ml-3 w-0 flex-1 pt-0.5">
            ...
            <p class="mt-1 text-sm text-indigo-700 dark:text-indigo-300">
              A new version is ready. Refresh to apply the update.
            </p>
            <div class="mt-3 flex space-x-3">
              <button type="button" class="btn-primary py-1.5 px-3 text-xs" (click)="refreshWithUpdate()">
                Refresh now
              </button>
            </div>
          </div>
