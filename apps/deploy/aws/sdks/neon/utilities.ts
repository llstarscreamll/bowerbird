...
/** @internal */
export async function callAsync<T>(tok: string, props: pulumi.Inputs, res?: pulumi.Resource, opts?: { property?: string }): Promise<T> {
  ...
  if (problem) {
    throw new Error(`Plain resource method "${tok}" incorrectly returned ${problem}. ` + 'This is an error in the provider, please report this to the provider developer.');
  }
...
export async function getPackage(): Promise<string | undefined> {
  return runtime.registerPackage({
    ...
    base64Parameter: 'eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL2tpc2xlcmRtL25lb24iLCJ2ZXJzaW9uIjoiMC4xNi4wIn19',
  });
}
