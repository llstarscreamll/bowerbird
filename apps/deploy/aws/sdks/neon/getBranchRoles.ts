...
export function getBranchRoles(args: GetBranchRolesArgs, opts?: pulumi.InvokeOptions): Promise<GetBranchRolesResult> {
...
export function getBranchRolesOutput(args: GetBranchRolesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBranchRolesResult> {
  opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
