...
export interface GetBranchEndpointsEndpointArgs {
   ...
   * Endpoint URI for connection pooling.
   */
  hostPooling?: pulumi.Input<string | undefined>;
  /**
   * Endpoint ID.
   */
...
export interface ProjectPrimaryCompute {
  /**
   * Maximal value of the autoscaling limit for the primary project compute.
   */
  autoscalingLimitMaxCu?: pulumi.Input<number | undefined>;
  /**
   * Minimal value of the autoscaling limit for the primary project compute.
   */
  autoscalingLimitMinCu?: pulumi.Input<number | undefined>;
  /**
   * Endpoint ID.
  ...
  name?: pulumi.Input<string | undefined>;
  /**
   * Duration of inactivity in seconds after which the default compute endpoint is automatically suspended.
