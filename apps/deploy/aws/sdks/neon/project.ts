...
export class Project extends pulumi.CustomResource {
  ...
  /**
   * Maximal value of the project-wide autoscaling limit.
  ...
  /**
   * Minimal value of the project-wide autoscaling limit.
   * Note that it is not retrospectively applicable, i.e., existing compute resources are not affected by this configuration.
   */
   ...
   */
  declare public readonly defaultBranchProtected: pulumi.Output<boolean | undefined>;
  /**
   * Default endpoint ID.
   */
   ...
   */
  declare public readonly hipaa: pulumi.Output<string | undefined>;
  /**
  ...
  /**
   * Primary read-write compute resource provisioned with the project.
   */
  declare public readonly primaryCompute: pulumi.Output<outputs.ProjectPrimaryCompute | undefined>;
  /**
  ...
  constructor(name: string, argsOrState?: ProjectArgs | ProjectState, opts?: pulumi.CustomResourceOptions) {
    ...
    if (opts.id) {
      ...
      resourceInputs['defaultBranchProtected'] = state?.defaultBranchProtected;
      ...
      resourceInputs['primaryCompute'] = state?.primaryCompute;
      ...
      resourceInputs['defaultBranchProtected'] = args?.defaultBranchProtected;
      resourceInputs['enableLogicalReplication'] = args?.enableLogicalReplication;
      resourceInputs['hipaa'] = args?.hipaa;
      ...
      resourceInputs['primaryCompute'] = args?.primaryCompute;
...
export interface ProjectState {
   ...
   * Set default branch as protected. **Note** that the default value is false.
   */
  defaultBranchProtected?: pulumi.Input<boolean | undefined>;
  /**
   * Default endpoint ID.
   */
   ...
   * **Warning**: Once enabled, HIPAA cannot be disabled.
   */
  hipaa?: pulumi.Input<string | undefined>;
  /**
   * The number of seconds to retain the point-in-time restore (PITR) backup history for this project.
   * Default: 1 day, see https://neon.tech/docs/reference/glossary#point-in-time-restore.
   */
   ...
   * Primary read-write compute resource provisioned with the project.
   */
  primaryCompute?: pulumi.Input<inputs.ProjectPrimaryCompute | undefined>;
  /**
   * Per-project consumption quota. If the quota is exceeded, all active computes
   * are automatically suspended and it will not be possible to start them with
   * an API method call or incoming proxy connections. The only exception is
