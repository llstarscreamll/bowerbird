        ...
        <header class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div class="min-w-0 space-y-2">
            ...
            <p class="max-w-2xl text-sm text-muted-foreground">
              Registra aquí las claves que Atta necesita para trabajar en nombre de la organización: APIs de sistemas externos, identidad (IdP), contraseñas de documentos y otras credenciales. Se
