...
export class HlmDialogService {
  ...
  public open<TResult = unknown, TContext = unknown>(component: ComponentType<unknown> | TemplateRef<unknown>, options?: Partial<HlmDialogOptions<TContext>>): BrnDialogRef<TResult> {
    const mergedOptions = {
      ...(options ?? {}),
