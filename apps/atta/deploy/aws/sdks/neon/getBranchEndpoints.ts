...
export function getBranchEndpoints(args: GetBranchEndpointsArgs, opts?: pulumi.InvokeOptions): Promise<GetBranchEndpointsResult> {
...
export function getBranchEndpointsOutput(args: GetBranchEndpointsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBranchEndpointsResult> {
  opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
