...
import (
	...
	outboxPublisher "github.com/atta/internal/platform/outbox/publisher"
	outboxStore "github.com/atta/internal/platform/outbox/store"
...
func buildBaseTenantDBUrl(databaseURL string) string {
	baseDbURL := strings.Replace(databaseURL, "/atta?", "/%s?", 1)
