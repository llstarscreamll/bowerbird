...
import (
	...
	"github.com/atta/internal/inbox/domain"
...
func (f *fakeFileStore) OpenFile(ctx context.Context, input platformStorage.OpenFileInput) (*platformStorage.OpenFileResult, error) {
	return nil, nil
}
