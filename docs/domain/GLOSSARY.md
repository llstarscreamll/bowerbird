...
| **Fusionar duplicados**         | Steward-confirmed collapse of two or more catalog items that represent the same product into one surviving item; aliases are unioned. Never automatic.                                                    | `Merge`                                  |
| **Ítem conservado**             | The catalog item that remains after a merge; retired items point to it via `merged_into_id`.                                                                                                              | survivor                                 |
