...
export class ProjectPermission extends pulumi.CustomResource {
   ...
   */
  public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProjectPermissionState, opts?: pulumi.CustomResourceOptions): ProjectPermission {
  ...
  constructor(name: string, argsOrState?: ProjectPermissionArgs | ProjectPermissionState, opts?: pulumi.CustomResourceOptions) {
