...
export class JwksUrl extends pulumi.CustomResource {
   ...
   */
  public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: JwksUrlState, opts?: pulumi.CustomResourceOptions): JwksUrl {
  ...
  constructor(name: string, argsOrState?: JwksUrlArgs | JwksUrlState, opts?: pulumi.CustomResourceOptions) {
