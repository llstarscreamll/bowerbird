...
export class VpcEndpointAssignment extends pulumi.CustomResource {
   ...
   */
  public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcEndpointAssignmentState, opts?: pulumi.CustomResourceOptions): VpcEndpointAssignment {
  ...
  constructor(name: string, argsOrState?: VpcEndpointAssignmentArgs | VpcEndpointAssignmentState, opts?: pulumi.CustomResourceOptions) {
