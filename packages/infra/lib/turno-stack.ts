...
export class TurnoStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const queue = new sqs.Queue(this, 'TurnoQueue', {
    ...
    const eventRule = new events.Rule(this, 'TurnoEventRule', {
      eventPattern: {
        source: ['turno.app']
      }
    });
    ...
    const httpApi = new apigwv2.HttpApi(this, 'TurnoHttpApi', {
      corsPreflight: {
